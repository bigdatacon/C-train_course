...
int main(int argc, char* argv[]) {
    ...
    if (mode == "make_base"sv) {
        ...
        catalogue_serialization(transport_catalogue, out_file);
        ...
        transport_catalogue = catalogue_deserialization(in_file);
            
        RequestHandler request_handler;       
        
        request_handler.execute_queries(transport_catalogue, 
                                        stat_request, 
                                        render_settings,
                                        routing_settings);
