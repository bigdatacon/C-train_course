...
int main(int argc, char* argv[]) {
    ...
    if (mode == "make_base"sv) {
        ...
        serialization::catalogue_serialization(tc, rd , out_file);
    }
        ...
        transport_catalogue_protobuf::Catalogue catalogue = catalogue_deserialization(in_file);
        //transport_catalogue::TransportCatalogue tc = serialization::catalogue_deserialization(in_file);
        RenderData rd = catalogue.render_settings;
        transport_catalogue::TransportCatalogue = catalogue.transport_catalogue;
