...
namespace serialization {
    ...
    void catalogue_serialization(transport_catalogue::TransportCatalogue& transport_catalogue, transport_catalogue::RenderSettings& render_settings, std::ostream& out) {
