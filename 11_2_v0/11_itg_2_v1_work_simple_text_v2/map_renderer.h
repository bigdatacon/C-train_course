...
struct Rout_description {
    ...
    uint32_t x_last, y_last; // координаты последней остановки если 1 и посл не равны 
    //uint32_t dx, dy; //смещение dx и dy равно настройке bus_label_offset;
    //uint32_t font_size ; // Размер шрифта size равен настройке bus_label_font_size;
