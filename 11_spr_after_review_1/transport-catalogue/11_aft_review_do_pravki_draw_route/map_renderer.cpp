...
std::map<string, Color> GetColorForRoute(const std::deque<transport_catalogue::Bus>& buses, std::vector<Color> color_palette) {
...
vector<geo::Coordinates> GetAllCoordinates(const TransportCatalogue& rtotc, const std::deque<transport_catalogue::Bus> buses) {
...
bool  CheckSameStations(const deque<string*>& current_stops) {
...
json::Node MapRenderer::DrawRouteGetNode(const TransportCatalogue& tc)  {
...
void MapRenderer::DrawRoute(const TransportCatalogue& tc) {
