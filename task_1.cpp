...
public:
    ...
    vector<Document> FindTopDocuments(const string& raw_query,
                                      /*DocumentStatus status = DocumentStatus::ACTUAL*/  bool (*sort_status) (int id, DocumentStatus status, int rating) = SortStatus) const {
        const Query query = ParseQuery(raw_query);
...
private:
    ...
    vector<Document> FindAllDocuments(const Query& query, /*DocumentStatus status*/ bool (*sort_status) (int id, DocumentStatus status, int rating) = SortStatus) const {
